...
<template>
    <i-article>
        <article class="demo-case">
            ...
            <inAnchor title="最佳实践" h2></inAnchor>
            <inAnchor title="谛听（DMap）" h3></inAnchor>
            <Row :gutter="32">
                <i-col span="10">
            ...
            <inAnchor title="智选" h3></inAnchor>
            <Row :gutter="32">
                <i-col span="10">
                    <p>智能选址（Smart  Selection，SS）是腾讯云与 TalkingData 联合，依托双方优势，结合经典模型和预测算法，将海量数据与机器学习有机整合，旨在解决实体门店的选址、商圈经营等场景问题，为智慧零售及多元化线下产业助力的数据智能产品。</p>
            ...
            <inAnchor title="App 统计分析" h3></inAnchor>
            <Row :gutter="32">
                <i-col span="10">
            ...
            <Row :gutter="32">
                <i-col span="10">
                    <p>Easy Mock 是由大搜车开发的一个可视化，并且能快速生成模拟数据的持久化服务。全站基于 iView 并且由服务端渲染（SSR）。</p>
                    <p><a href="https://easy-mock.com/" target="_blank">立即访问</a></p>
                </i-col>
                <i-col span="14">
            ...
            <inAnchor title="MarketingCloud 营销云" h3></inAnchor>
            <Row :gutter="32">
                <i-col span="10">
