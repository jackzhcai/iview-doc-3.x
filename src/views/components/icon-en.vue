...
<template>
    <i-article>
        <article>
            ...
            <p>iView uses open source icon set <a href="http://ionicons.com/" target="_blank"><Icon type="ios-ionic"></Icon> ionicons</a> version 3.x</p>
            ...
            <Demo title="Custom icon usage">
                ...
                <div slot="desc">
                    <p>iView's Icon supports the use of third-party custom icons. You can use any font file library.</p>
                </div>
                <i-code lang="html" slot="code">{{ code.custom }}</i-code>
            </Demo>

            <Alert show-icon>
                <template slot="desc">iView 3 uses icons for ionicons 3.x. iView 2 uses icons for ionicons 2.x. If you upgrade from iView 2 to iView 3, you need to find and modify the used icon names because many icon names have changed.</template>
            </Alert>
