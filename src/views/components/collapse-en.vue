    ...
    <i-article>
        <article>
            ...
            <Demo title="Simple">
                ...
                <div slot="desc">
                    <p>Setting the property <code>simple</code> can be displayed in compact mode without borders and background colors.</p>
                </div>
            ...
            <div class="api">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>simple</td>
                            <td>Whether to open simple mode.</td>
                            <td>Boolean</td>
                            <td>false</td>
                        </tr>
                    </tbody>
